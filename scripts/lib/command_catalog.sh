...
declare -A AGENTBOT_COMMAND_SUMMARY=(
	...
	[update]='Run the repo-first update, reconcile skills, and refresh workspaces plus global outputs.'
...
declare -A AGENTBOT_COMMAND_EFFECTS=(
	...
	[update]='May pull/reconcile source-owned skills, then refresh registered workspaces and global Codex/Claude outputs after confirmation.'
