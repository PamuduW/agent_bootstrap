...
declare -A AGENTBOT_COMMAND_SUMMARY=(
	...
	[update]='Refresh upstream skills and managed workspace/global outputs after the repo-first gate.'
...
declare -A AGENTBOT_COMMAND_EFFECTS=(
	...
	[update]='May pull/reconcile source-owned skills, then refresh registered workspaces and global Codex/Claude outputs; --yes pre-approves source-owned deltas.'
...
declare -A AGENTBOT_BACKEND_SUMMARY=(
	...
	[update]='Run repository-first skill reconciliation, then refresh workspaces and global Codex/Claude outputs.'
