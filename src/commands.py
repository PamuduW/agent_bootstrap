...
COMMANDS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        (
            option("status", "Inspect CLI, safety config, and Claude/Codex state.", "default"),
            option("setup", "Preview and configure Claude and Codex only.", "explicit"),
            option("off", "Preview and remove Claude and Codex integration.", "explicit"),
        ),
        "Status is read-only; setup/off may update Boost config and Claude/Codex hooks.",
